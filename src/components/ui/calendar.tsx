  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal text-gray-300 hover:bg-[#2e2e2e] hover:text-white rounded-md transition-all aria-selected:opacity-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-white text-black hover:bg-gray-100 hover:text-black focus:bg-white focus:text-black font-medium rounded-md",
        day_today: "bg-[#2e2e2e] text-white font-medium rounded-md",
        day_outside:
